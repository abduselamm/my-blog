...
export default function SectionContainer({ children, showads = true }) {
  return (
    <div className="flex h-auto">
      {showads ? (
        <div className="relative hidden w-72 flex-col justify-end overflow-auto py-3 px-5 sm:flex h-screen">
      ...
      {showads ? (
        <div className="relative hidden w-72 flex-col overflow-auto p-4 px-5 sm:flex h-screen ">
