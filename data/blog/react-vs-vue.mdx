...
draft: false
summary: 'If you want to build a large application with ease of development, choose React JS; if you want to build a simple application with the best documentation and easy integration, choose Vue.js...'
---
